	...
	\begin{columns} % See Section 4.4
		...
		\block{Methods}{
			...
			\begin{itemize}
				...
				\item DifferentialGeometry (Maple package)
				\item LieAlgebras (Maple package)
			\end{itemize}
			\vspace{0.25in}			
			\textbf{Approach}
			\begin{enumerate}
		...
		\block{Results}{
			...
			$$U(x,y,u) = \frac{(-x+y)(\frac{d}{dx}f(x)}{2} + \frac{(-x+y)(\frac{d}{dy}g(y)}{2} + f(x) - g(y) + (c_1x + c_1y + c_2)u$$}
			\vspace{0.5in}				
			...
			$$U(x,y,u) = \frac{1}{2(x + y)}((x-y)(\frac{d}{dx}f(x)) + (-x + y)(\frac{d}{dy}g(y)) - 2f(x) - 2g(y) + 2u(c_1y+c_2)x + 2c_2uy + 2c_3u)$$
			}
